...
(
    ...
    CONSTRAINT fk_codigo_postal
        FOREIGN KEY (codigo_postal_id) REFERENCES codigo_postal (codigo_postal),
...
(
    ...
    CONSTRAINT fk_paciente_tipo_via
        FOREIGN KEY (tipo_via) REFERENCES tipo_via (id),
...
(
    ...
    CONSTRAINT pk_toma
        PRIMARY KEY (id),
    CONSTRAINT ck_toma_null
        CHECK (hora         IS NOT NULL AND
               dosis        IS NOT NULL AND
...
(
    ...
    CONSTRAINT fk_paciente_medicamento_toma
        FOREIGN KEY (paciente_id) REFERENCES paciente (usuario_id),
